                ...
                <div className="flex space-x-3">
                  <div className="flex-1 p-3 bg-gray-100 rounded-lg">
                    <div className="text-center">
                      <div className="text-lg font-bold">{headingStructure.h2}</div>
                      <div className="text-xs mt-1 text-gray-600">H2 Tags</div>
                    </div>
                  </div>
                  
                  <div className="flex-1 p-3 bg-gray-100 rounded-lg">
                    <div className="text-center">
                      <div className="text-lg font-bold">{headingStructure.h3}</div>
                      <div className="text-xs mt-1 text-gray-600">H3 Tags</div>
                    </div>
                  </div>
                  
                  <div className="flex-1 p-3 bg-gray-100 rounded-lg">
                    <div className="text-center">
                      <div className="text-lg font-bold">{headingStructure.total}</div>
                      <div className="text-xs mt-1 text-gray-600">Total</div>
                    </div>
                  </div>
                </div>
              </div>
