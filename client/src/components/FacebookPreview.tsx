      ...
      {!hasOgTags ? (
        <div className="preview-container rounded-lg overflow-hidden border border-gray-200 bg-gray-50">
          <div className="p-6 text-center">
            ...
            <h3 className="text-base font-medium text-gray-600 mb-1">No Facebook Preview Available</h3>
            <p className="text-sm text-gray-500">
              This page is missing the required Open Graph tags for Facebook sharing.
              Add og:title, og:description, and og:image tags to enable sharing on Facebook.
            </p>
          </div>
        </div>
      ) : (
